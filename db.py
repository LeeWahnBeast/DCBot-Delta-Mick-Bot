...
DEFAULT_USER = {
    ...
    "tx_history": [],  # list[dict] lịch sử giao dịch MICK gần nhất (xem economy._append_tx), tối đa TX_HISTORY_MAX dòng
    "atm_last_interest_at": 0,  # unix ts lần cuối cộng lãi ATM (0 = chưa từng gửi/chưa tính lãi lần nào)
}
